...
class LlamaRushHourInference:
    def __init__(self, model_name="meta-llama/Meta-Llama-3.1-8B-Instruct", device="auto"):
        """
        Initialize Llama model for 4x4 Rush Hour puzzle inference.
...
Step 7: C [3,4] -> [2,4]
    ...
    def save_puzzle_result(self, output_path: str, puzzle_num: int, 
        ...
        result_file = os.path.join(puzzle_result_folder, f"llama_4x4_puzzle{puzzle_num}_result.json")
    ...
    def run_inference_on_dataset(self, dataset_path: str = "/root/rushhoureval/data/4x4", 
        ...
        print(f"Starting 4x4 inference with Llama model...")
        ...
        print(f"Individual results saved in: {output_path}/puzzle[N]/llama_4x4_puzzle[N]_result.json")
    ...
    def save_results_summary(self, results: List[Dict], output_path: str, timestamp: str):
        ...
        json_file = os.path.join(output_path, f"llama_4x4_inference_results_{timestamp}.json")
        with open(json_file, 'w', encoding='utf-8') as f:
            json.dump(results, f, indent=2, ensure_ascii=False)
        
        # Save CSV summary
        csv_file = os.path.join(output_path, f"llama_4x4_inference_summary_{timestamp}.csv")
...
def main():
    ...
    print("🚀 Starting Llama 3.1-8B 4x4 Rush Hour Inference")
    print("=" * 60)
