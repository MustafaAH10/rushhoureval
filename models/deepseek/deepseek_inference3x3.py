...
class DeepSeekReasoner3x3Inference:
    def __init__(self, api_key: str = None, model_name: str = "deepseek-reasoner"):
        """
        Initialize DeepSeek Reasoner model for 3x3 Rush Hour puzzle inference.
...
4. Think through the problem step by step to find the optimal solution
...
Step 4: C [2,2] -> [2,3]
    ...
    def parse_solution(self, response: str) -> List[str]:
        """
        Parse solution steps from DeepSeek model response.
    ...
    def save_puzzle_result(self, output_path: str, puzzle_num: int, 
        ...
        Args:
            ...
            content: DeepSeek final answer content
            reasoning_content: DeepSeek Chain of Thought reasoning
        ...
        result_file = os.path.join(puzzle_result_folder, f"deepseek_3x3_puzzle{puzzle_num}_result.json")
    ...
    def run_inference_on_dataset(self, dataset_path: str = "/root/rushhoureval/data/3x3", 
                                output_path: str = "deepseek_results3x3", 
                                max_puzzles: Optional[int] = None,
                                start_puzzle: int = 1,
                                delay_between_requests: float = 1.0):
        """
        Run inference on all puzzles in the dataset using DeepSeek Reasoner.
        ...
        print(f"Individual results saved in: {output_path}/puzzle[N]/deepseek_3x3_puzzle[N]_result.json")
    ...
    def save_results_summary(self, results: List[Dict], output_path: str, timestamp: str, total_usage: Dict):
        ...
        json_file = os.path.join(output_path, f"deepseek_3x3_inference_results_{timestamp}.json")
        summary_data = {
            'model_info': {
        ...
        # Save CSV summary
        csv_file = os.path.join(output_path, f"deepseek_3x3_inference_summary_{timestamp}.csv")
...
def main():
    ...
    print("🚀 Starting DeepSeek Reasoner 3x3 Rush Hour Inference")
    print("=" * 60)
    ...
    inference = DeepSeekReasoner3x3Inference(
