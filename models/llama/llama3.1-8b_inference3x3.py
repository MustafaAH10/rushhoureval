...
class LlamaRushHourInference:
    def __init__(self, model_name="meta-llama/Meta-Llama-3.1-8B-Instruct", device="auto"):
        """
        Initialize Llama model for Rush Hour puzzle inference.
...
"""
    ...
    def create_chat_prompt(self, puzzle_prompt: str) -> str:
        """
        Create a chat-formatted prompt for Llama model.
    ...
    def save_puzzle_result(self, output_path: str, puzzle_num: int, 
        ...
        result_file = os.path.join(puzzle_result_folder, f"llama_puzzle{puzzle_num}_result.json")
    ...
    def run_inference_on_dataset(self, dataset_path: str = "../../data/3x3", 
                                output_path: str = "models/llama/results3x3", 
        ...
        print(f"Starting inference with Llama model...")
        ...
        print(f"Individual results saved in: {output_path}/puzzle[N]/llama_puzzle[N]_result.json")
    ...
    def save_results_summary(self, results: List[Dict], output_path: str, timestamp: str):
        ...
        json_file = os.path.join(output_path, f"llama_inference_results_{timestamp}.json")
        with open(json_file, 'w', encoding='utf-8') as f:
            json.dump(results, f, indent=2, ensure_ascii=False)
        
        # Save CSV summary
        csv_file = os.path.join(output_path, f"llama_inference_summary_{timestamp}.csv")
...
def main():
    ...
    print("🚀 Starting Llama 3.1-8B Rush Hour Inference")
    print("=" * 60)
    
    # Initialize inference system
    inference = LlamaRushHourInference(
