...
Step 4: C [2,2] -> [2,4]
    ...
    def run_inference_on_dataset(self, dataset_path: str = "data/4x4", 
                                output_path: str = "qwen7b/results4x4", 
...
def main():
    ...
    print("🚀 Starting Qwen 2.5-7B 4x4 Rush Hour Inference")
    print("=" * 60)
    ...
    # Configuration
    dataset_path = "data/4x4"
    output_path = "qwen7b/results4x4"
