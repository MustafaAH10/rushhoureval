...
class GPT5_5x5_RushHourInference:
    def __init__(self, api_key: str = None, model_name: str = "gpt-5"):
        """
        Initialize GPT-5 model for 5x5 Rush Hour puzzle inference using the responses API.
...
Remember: The goal is to position car "C" so it exactly covers both target cells {target_zone_str}."""
    ...
    def save_puzzle_result(self, output_path: str, puzzle_num: int, 
        ...
        result_file = os.path.join(puzzle_result_folder, f"gpt5_5x5_puzzle{puzzle_num}_result.json")
    ...
    def run_inference_on_dataset(self, dataset_path: str = "/root/rushhoureval/data/5x5", 
        ...
        """
        Run inference on all 5x5 puzzles in the dataset using GPT-5.
        ...
        print(f"Individual results saved in: {output_path}/puzzle[N]/gpt5_5x5_puzzle[N]_result.json")
    ...
    def save_results_summary(self, results: List[Dict], output_path: str, timestamp: str, total_usage: Dict):
        ...
        json_file = os.path.join(output_path, f"gpt5_5x5_inference_results_{timestamp}.json")
        summary_data = {
            'model_info': {
        ...
        # Save CSV summary
        csv_file = os.path.join(output_path, f"gpt5_5x5_inference_summary_{timestamp}.csv")
    ...
    def analyze_results(self, results: List[Dict]) -> Dict[str, Any]:
        """Analyze inference results and compute metrics for 5x5 puzzles including reasoning analysis"""
        if not results:
            return {}
...
def main():
    ...
    print("Starting GPT-5 5x5 Rush Hour Inference")
    print("=" * 60)
    ...
    inference = GPT5_5x5_RushHourInference(
        model_name="gpt-5",
        api_key=api_key
    )
