...
class OlmoRushHourInference:
    def __init__(self, model_name="allenai/OLMo-2-1124-13B-Instruct", device="auto"):
        """
        Initialize Olmo model for Rush Hour puzzle inference.
...
"""
    ...
    def create_chat_prompt(self, puzzle_prompt: str) -> str:
        """
        Create a chat-formatted prompt for Olmo model.
    ...
    def generate_response(self, prompt: str, max_new_tokens: int = 8192, temperature: float = 0.5) -> str:
        """
        Generate response from Olmo model.
    ...
    def save_puzzle_result(self, output_path: str, puzzle_num: int, 
        ...
        result_file = os.path.join(puzzle_result_folder, f"olmo_puzzle{puzzle_num}_result.json")
    ...
    def run_inference_on_dataset(self, dataset_path: str = "../../data/3x3", 
                                output_path: str = "models/olmo/results3x3", 
        ...
        print(f"Starting inference with Olmo model...")
        ...
        print(f"Individual results saved in: {output_path}/puzzle[N]/olmo_puzzle[N]_result.json")
    ...
    def save_results_summary(self, results: List[Dict], output_path: str, timestamp: str):
        ...
        json_file = os.path.join(output_path, f"olmo_inference_results_{timestamp}.json")
        with open(json_file, 'w', encoding='utf-8') as f:
            json.dump(results, f, indent=2, ensure_ascii=False)
        
        # Save CSV summary
        csv_file = os.path.join(output_path, f"olmo_inference_summary_{timestamp}.csv")
...
def main():
    ...
    print("🚀 Starting Olmo 13B Rush Hour Inference")
    print("=" * 60)
    
    # Initialize inference system
    inference = OlmoRushHourInference(
