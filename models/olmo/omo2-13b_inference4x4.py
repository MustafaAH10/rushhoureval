...
class Olmo4x4RushHourInference:
    def __init__(self, model_name="allenai/OLMo-2-1124-13B-Instruct", device="auto"):
        """
        Initialize Olmo model for 4x4 Rush Hour puzzle inference.
...
Step 7: C [3,4] -> [2,4]
    ...
    def save_puzzle_result(self, output_path: str, puzzle_num: int, 
        ...
        result_file = os.path.join(puzzle_result_folder, f"olmo_4x4_puzzle{puzzle_num}_result.json")
    ...
    def run_inference_on_dataset(self, dataset_path: str = "/root/rushhoureval/data/4x4", 
        ...
        print(f"Starting 4x4 inference with Olmo model...")
        ...
        print(f"Individual results saved in: {output_path}/puzzle[N]/olmo_4x4_puzzle[N]_result.json")
    ...
    def save_results_summary(self, results: List[Dict], output_path: str, timestamp: str):
        ...
        json_file = os.path.join(output_path, f"olmo_4x4_inference_results_{timestamp}.json")
        with open(json_file, 'w', encoding='utf-8') as f:
            json.dump(results, f, indent=2, ensure_ascii=False)
        
        # Save CSV summary
        csv_file = os.path.join(output_path, f"olmo_4x4_inference_summary_{timestamp}.csv")
...
def main():
    ...
    print("🚀 Starting Olmo 13B 4x4 Rush Hour Inference")
    print("=" * 60)
    
    # Initialize inference system
    inference = Olmo4x4RushHourInference(
